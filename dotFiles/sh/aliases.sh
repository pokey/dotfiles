...
alias  pis='pip install flake8 flake8-isort flake8-print mypy ipdb python-language-server'
alias  pup='pip install --upgrade pip'
alias pisj='pip install flake8 flake8-isort flake8-print mypy ipdb python-language-server jupyterlab'
alias    k='cd ..'
alias   kk='cd ../..'
alias  kkk='cd ../../..'
alias   k2='cd ../..'
...
alias in2csv="csvkit-run in2csv"
